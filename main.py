...
for n in tqdm.tqdm(range(10)):
    ...
    list_projectors, list_TT_cores, list_labels, time_TT, time_proj= get_projectors(file_videos, TT_ranks)
...
list_projectors, list_TT_cores, list_labels, time_TT, time_proj = get_projectors('extended_processed', TT_ranks)
J_train =  precomputed_kernel_matrix(list_projectors, list_projectors)
t0 = time.time()
J_train_opt =  precomputed_kernel_matrix_opt(list_projectors, list_projectors)
